...
?>
          ...
          <p>
          	В този случай имате пет светофара.
          </p>
...
<form  method="post" >
           ...
           3: <br>
            <input type="number" name="trafficLight[2][]" value="" placeholder="distance"><br>
            <input type="number" name="trafficLight[2][]" value="" placeholder="frequency"><br>
           4: <br>
            <input type="number" name="trafficLight[3][]" value="" placeholder="distance"><br>
            <input type="number" name="trafficLight[3][]" value="" placeholder="frequency"><br>
           5: <br>
            <input type="number" name="trafficLight[4][]" value="" placeholder="distance"><br>
            <input type="number" name="trafficLight[4][]" value="" placeholder="frequency"><br>
            <br>
